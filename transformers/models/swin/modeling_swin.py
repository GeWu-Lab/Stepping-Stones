...
class SwinSelfOutput(nn.Module):
    def __init__(self, config, dim):
        ...
        self.dropout = nn.Dropout(config.attention_probs_dropout_prob)
        self.swin_adapt_1 = nn.Sequential(
            nn.Linear(dim, dim//4),
            nn.ReLU(),
            nn.Linear(dim//4, dim),
        )
    ...
    def forward(self, hidden_states: torch.Tensor, input_tensor: torch.Tensor) -> torch.Tensor:
        ...
        # adapter - avs.
        hidden_states = self.swin_adapt_1(hidden_states) + hidden_states
...
class SwinIntermediate(nn.Module):
    def __init__(self, config, dim):
        ...
        _dim = int(config.mlp_ratio * dim)
        # self.swin_adapt_2 = nn.Sequential(
        #     nn.Linear(_dim, _dim//4),
        #     nn.ReLU(),
        #     nn.Linear(_dim//4, _dim),
        # )
    ...
    def forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
        ...
        # swin adapt - avs.
        # hidden_states = self.swin_adapt_2(hidden_states) + hidden_states
        return hidden_states
...
class SwinOutput(nn.Module):
    def __init__(self, config, dim):
        ...
        self.swin_adapt_3 = nn.Sequential(
            nn.Linear(dim, dim//4),
            nn.ReLU(),
            nn.Linear(dim//4, dim),
        )
    ...
    def forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
        ...
        # swin - adapt
        hidden_states = self.swin_adapt_3(hidden_states) + hidden_states
        return hidden_states
